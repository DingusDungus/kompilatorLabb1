...
#line 824 "parser.tab.cc"
  ...
  case 7: // factor: INTEGER
#line 72 "parser.yy"
                 {  yylhs.value.as < Node * > () = new Node("Integer", yystack_[0].value.as < std::string > ()); printf("r6 "); /* Here we create a leaf node Int. The value of the leaf node is $1 */}
#line 830 "parser.tab.cc"
    break;

  case 8: // factor: LP program RP
#line 73 "parser.yy"
...
#undef YYCASE_
  ...
  "MULTOP", "MINUS", "DIVOP", "LP", "RP", "LBRACE", "RBRACE", "LBRACKET",
  "RBRACKET", "STRING", "BOOLEAN", "IDENTIFIER", "INT", "ASSIGN", "NEW",
  "THIS", "LENGTH", "STRINGVAL", "INTEGER", "TRUE", "FALSE", "FOR", "IF",
  "ELSE", "WHILE", "AND", "LESSER", "EQUAL", "NOT", "GREATER", "OR",
  "MAIN", "EXTENDS", "PUBLIC", "VOID", "RETURN", "CLASS", "SOP", "DOT",
  "COMMA", "SEMI_C", "$accept", "program", "addExpression",
