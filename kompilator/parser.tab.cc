      ...
      switch (yyr1_[yyn])
    {
      ...
      try
#endif // YY_EXCEPTIONS
        {
          switch (yyn)
            {
  case 2: // expression: addExpression
#line 35 "parser.yy"
                          { /*  
...
#undef YYCASE_
  ...
  "MULTOP", "MINUS", "LP", "RP", "LBRACE", "RBRACE", "LBRACKET",
  "RBRACKET", "STRING", "BOOLEAN", "IDENTIFIER", "INT", "ASSIGN", "NEW",
  "THIS", "LENGTH", "STRINGVAL", "INTEGER", "TRUE", "FALSE", "FOR", "IF",
  "ELSE", "WHILE", "AND", "LESSER", "EQUAL", "NOT", "MAIN", "EXTENDS",
  "PUBLIC", "VOID", "RETURN", "CLASS", "SOP", "DOT", "COMMA", "SEMI_C",
  "$accept", "expression", "addExpression", "multExpression", "factor", YY_NULLPTR
  };
#endif
